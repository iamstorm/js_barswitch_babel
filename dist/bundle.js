...
/***/ function(module, exports, __webpack_require__) {
	...
	var _barswitch = __webpack_require__(36);
	
	var _barswitch2 = _interopRequireDefault(_barswitch);
	...
	var _reduxDevtoolsLogMonitor = __webpack_require__(165);
	
	var _reduxDevtoolsLogMonitor2 = _interopRequireDefault(_reduxDevtoolsLogMonitor);
	
	var _reduxDevtoolsDockMonitor = __webpack_require__(336);
	
	var _reduxDevtoolsDockMonitor2 = _interopRequireDefault(_reduxDevtoolsDockMonitor);
	
	var _barswitch3 = __webpack_require__(29);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	(0, _isomorphicFetch2.default)("./demo.json").then(function (response) {
	    ...
	    var store = (0, _redux.createStore)(_barswitch2.default, DevTools.instrument());
	
	    store.dispatch((0, _barswitch3.data_refresh)(json));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MainbarCon = __webpack_require__(4);
	
	var _MainbarCon2 = _interopRequireDefault(_MainbarCon);
	
	var _SidebarCon = __webpack_require__(32);
	
	var _SidebarCon2 = _interopRequireDefault(_SidebarCon);
	
	var _ContentCon = __webpack_require__(34);
	
	var _ContentCon2 = _interopRequireDefault(_ContentCon);
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                "div",
	                null,
	                _react2.default.createElement(_MainbarCon2.default, null),
	                _react2.default.createElement(
	                    "div",
	                    { className: "ContentBody" },
	                    _react2.default.createElement(_SidebarCon2.default, null),
	                    _react2.default.createElement(_ContentCon2.default, null)
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _barswitch = __webpack_require__(29);
	
	var _Mainbar = __webpack_require__(31);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    ...
	    return {
	        onClickMainbar: function onClickMainbar(item) {
	            dispatch((0, _barswitch.click_mainbar)(item));
	            dispatch((0, _barswitch.force_sync_content)());
	        },
	        onClickRefreshBtn: function onClickRefreshBtn() {
	            demoSwitch = !demoSwitch;
	            fetch(demoSwitch ? "./demo1.json" : "./demo.json").then(function (response) {
	                return response.json();
	            }).then(function (json) {
	                dispatch((0, _barswitch.data_refresh)(json));
	            });
	        }
	    };
	};
	
	var MainbarCon = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_Mainbar2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function force_sync_content() {
	    return {
	        type: _constants.FORCE_SYNC_CONTENT
	    };
	}
	
	function complete_force_sync_content() {
	    return {
	        type: _constants.COMPLETE_FORCE_SYNC_CONTENT
	    };
	}
	function data_refresh(bardata) {
	    return {
	        type: _constants.BARDATA_REFRESH,
	        bardata: bardata
	    };
	}
...
/***/ function(module, exports) {
	...
	var CLICK_MAINBAR = exports.CLICK_MAINBAR = 'CLICK_MAINBAR';
	var CLICK_SIDEBAR = exports.CLICK_SIDEBAR = 'CLICK_SIDEBAR';
	var FORCE_SYNC_CONTENT = exports.FORCE_SYNC_CONTENT = 'NEED_SYNC_CONTENT';
	var COMPLETE_FORCE_SYNC_CONTENT = exports.COMPLETE_FORCE_SYNC_CONTENT = 'COMPLETE_FORCE_SYNC_CONTENT';
	var BARDATA_REFRESH = exports.BARDATA_REFRESH = 'BARDATA_REFRESH';
	...
	var Mainbar = function (_React$Component) {
	    ...
	    _createClass(Mainbar, [{
	        ...
	        value: function render() {
	            ...
	            var buildLink = function buildLink(item, index) {
	                if (item == _this2.props.activeMainbar) {
	                    return _react2.default.createElement(
	                        "li",
	                        { className: "active", key: index },
	                        _react2.default.createElement(
	                            "a",
	                            { href: "javascrip:void(0)", onClick: function onClick() {
	                                    return _this2.props.onClickMainbar(item);
	                                } },
	                            item
	                        )
	                    );
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    "ul",
	                    null,
	                    this.props.bardata.Mainbar.map(function (item, index) {
	                        return buildLink(item, index);
	                    })
	                ),
	                _react2.default.createElement(
	                    "button",
	                    { onClick: this.props.onClickRefreshBtn },
	                    "refresh data"
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return {
	        onClickSidebar: function onClickSidebar(item) {
	            dispatch((0, _barswitch.click_sidebar)(item));
	            dispatch((0, _barswitch.force_sync_content)());
	        }
	    };
	};
	
	var SidebarCon = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_Sidebar2.default);
	...
	var Sidebar = function (_React$Component) {
	    ...
	    _createClass(Sidebar, [{
	        ...
	        value: function render() {
	            ...
	            var buildLink = function buildLink(item, index) {
	                if (item == _this2.props.activeSidebarItem) {
	                    return _react2.default.createElement(
	                        "li",
	                        { className: "active", key: index },
	                        _react2.default.createElement(
	                            "a",
	                            { href: "javascrip:void(0)", onClick: function onClick() {
	                                    return _this2.props.onClickSidebar(item);
	                                } },
	                            item
	                        )
	                    );
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    "ul",
	                    null,
	                    this.props.bardata[this.props.activeMainbar].map(function (item, index) {
	                        return buildLink(item, index);
	                    })
	                )
	            );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return {
	        onSyncComplete: function onSyncComplete(item) {
	            dispatch((0, _barswitch.complete_force_sync_content)());
	        }
	    };
	};
	
	var ContentCon = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_Content2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Content = function (_React$Component) {
	    ...
	    function Content(props, context) {
	        ...
	        _this.syncWithBar = _this.syncWithBar.bind(_this);
	    ...
	    _createClass(Content, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement("div", { className: "content", ref: function ref(c) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function update() {
	    ...
	    if (action.type === _constants.CLICK_MAINBAR) {
	        nextState.bardata.activeMainbar = action.item;
	        return nextState;
	    }
	    if (action.type === _constants.CLICK_SIDEBAR) {
	        nextState.bardata.activeSidebar[nextState.bardata.activeMainbar] = action.item;
	        return nextState;
	    }
	    if (action.type === _constants.FORCE_SYNC_CONTENT) {
	        nextState.bardata.forceSyncContent = true;
	        return nextState;
	    }
	    if (action.type === _constants.COMPLETE_FORCE_SYNC_CONTENT) {
	        nextState.bardata.forceSyncContent = false;
	        return nextState;
	    }
	    if (action.type === _constants.BARDATA_REFRESH) {
	        ...
	        try {
	            for (var _iterator = nextState.bardata.Mainbar[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
